      ...
      <div className="Container">
        ...
        <section className="Slide2">
          <p className="Description1">
            We believe the more visible a path, the more people are likely to take a chance and travel it. Our mission is to utilize the resources of Yale and Calhoun College to illuminate diverse, unconventional and worthwhile paths.
          </p>
          ...
          <p className="Description3">
            We will also have a Slack dedicated to TraveledBy, where students and speakers can connect, Q&A, and share opportunities and info over the web. Add your email above and we’ll send you an invite!
            <br/><br/>
